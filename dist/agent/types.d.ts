...
export type NodeState = 'idle' | 'allocated' | 'busy' | 'degraded' | 'unhealthy' | 'releasing' | 'maintenance' | 'cooling' | 'banned';
...
export type PlatformId = 'douyin' | 'xiaohongshu' | 'kuaishou' | 'instagram' | 'tiktok';
