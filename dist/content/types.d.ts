...
export type IndustryId = 'beauty' | 'fitness' | 'food' | 'tech' | 'travel' | 'fashion' | 'parenting' | 'education' | 'finance' | 'health' | 'entertainment' | 'automotive' | 'realestate' | 'pet' | 'wedding' | 'home' | 'sports' | 'gaming' | 'music' | 'art' | string;
