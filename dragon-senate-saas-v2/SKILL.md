...
### skill: libtv-render
- Description: Generate short-video assets with LibTV OpenAPI session workflow.
- Shebang example:
  - `#!/usr/bin/env -S pkgx +python@3.12 python`
- pkgx command:
  - `# pkgx: pkgx +python@3.12 python scripts/skills/libtv_render.py --storyboard payload.json`

### skill: comfyui-render
- Description: Generate local image/video assets through ComfyUI workflow API.
- Shebang example:
  - `#!/usr/bin/env -S pkgx +python@3.12 python`
- pkgx command:
  - `# pkgx: pkgx +python@3.12 python scripts/skills/comfyui_render.py --storyboard payload.json`
